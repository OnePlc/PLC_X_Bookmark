<?php
/**
 * BookmarkControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Bookmark Module
 *
 * @category Test
 * @package Bookmark
...
namespace OnePlaceTest\Bookmark\Controller;

use OnePlace\Bookmark\Controller\BookmarkController;
...
class BookmarkControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/bookmark/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('bookmark');
        $this->assertControllerName(BookmarkController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BookmarkController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/bookmark/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('bookmark');
        $this->assertControllerName(BookmarkController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BookmarkController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/bookmark/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('bookmark');
        $this->assertControllerName(BookmarkController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BookmarkController');
