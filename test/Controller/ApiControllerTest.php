...
use OnePlace\Bookmark\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/bookmark/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/bookmark/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('bookmark-api');
    }
}
