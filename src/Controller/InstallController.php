...
class InstallController extends CoreUpdateController {
    ...
    public function checkdbAction()
    {
        ...
        $this->setThemeBasedLayout('bookmark');
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-bookmark',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-bookmark/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-bookmark/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-bookmark/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key'=>'oneplace-bookmark',
                'type'=>'module',
                'version'=>\OnePlace\Bookmark\Module::VERSION,
                'label'=>'onePlace Bookmark',
                'vendor'=>'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Bookmark DB Update successful');
