<?php
/**
 * SearchController.php - Bookmark Search Controller
 *
 * Main Controller for Bookmark Search
 *
 * @category Controller
 * @package Bookmark
...
class SearchController extends CoreSearchController
{
    ...
    /**
     * Dump Bookmark data to desired format
     *
     * @return bool
     * @since 1.0.0
     */
    public function indexAction() {
         ...
         * Hooks available:
         *
         * bookmark-search-before (before show search form)
         * bookmark-search-before-execute (before query)
         * bookmark-search-after-execute (after query - before show results)
         */
        return $this->generateSearchView('bookmark');
    }
}